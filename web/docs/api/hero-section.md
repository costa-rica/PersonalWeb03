...
- `up_to_lately.text` - Summary content from `logbook-7-day-summary.json` (`summary` field)
...
- Reads summary and date from `{PATH_PROJECT_RESOURCES}/services-data/logbook-7-day-summary.json`
